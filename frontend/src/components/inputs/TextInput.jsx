...
// types
import { textInputTypes } from 'src/types';

const TextInput = ({ options, register, errors }) => {
    const { type, name, label, info, placeholder, defaultValue, disabled, autocomplete, autofocus, validation } = options;
